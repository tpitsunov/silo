...
Для корпоративных сред SILO также поддерживает приоритетное получение секретов из [HashiCorp Vault](../integrations/vault.md).
...
**Далее:** Узнайте, как [Динамическая маршрутизация](../guide/routing.md) помогает агентам находить ваши инструменты.
